...
--
-- 表的结构 `winshop_action_log`
--

CREATE TABLE IF NOT EXISTS `winshop_action_log` (
...
INSERT INTO `winshop_action_log` (`id`, `action_id`, `user_id`, `action_ip`, `model`, `record_id`, `remark`, `status`, `create_time`) VALUES
(1, 1, 1, 2130706433, 'member', 1, 'admin在2014-03-12 10:04登录了后台', 1, 1394589857),
(2, 1, 1, 2130706433, 'member', 1, 'admin在2014-03-12 12:56登录了后台', 1, 1394600215),
(3, 1, 1, 2130706433, 'member', 1, 'admin在2014-03-12 13:54登录了后台', 1, 1394603677),
(4, 1, 1, 2130706433, 'member', 1, 'admin在2014-03-12 14:01登录了后台', 1, 1394604119),
(5, 10, 1, 2130706433, 'Menu', 122, '操作url：/winshop/index.php?s=/Admin/Menu/add.html', 1, 1394604671),
(6, 10, 1, 2130706433, 'Menu', 122, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1394604963),
(7, 10, 1, 2130706433, 'Menu', 1, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1394605159),
(8, 10, 1, 2130706433, 'Menu', 1, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1394605314),
(9, 10, 1, 2130706433, 'Menu', 122, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1394605347),
(10, 10, 1, 2130706433, 'Menu', 122, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1394605478),
(11, 10, 1, 2130706433, 'Menu', 122, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1394606008),
(12, 10, 1, 2130706433, 'Menu', 1, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1394606486),
(13, 10, 1, 2130706433, 'Menu', 123, '操作url：/winshop/index.php?s=/Admin/Menu/add.html', 1, 1394607215),
(14, 10, 1, 2130706433, 'Menu', 123, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1394607243),
(15, 10, 1, 2130706433, 'Menu', 124, '操作url：/winshop/index.php?s=/Admin/Menu/add.html', 1, 1394607289),
(16, 10, 1, 2130706433, 'Menu', 124, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1394607310),
(17, 10, 1, 2130706433, 'Menu', 123, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1394607316),
(18, 10, 1, 2130706433, 'Menu', 125, '操作url：/winshop/index.php?s=/Admin/Menu/add.html', 1, 1396141579),
(19, 10, 1, 2130706433, 'Menu', 125, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1396141592),
(20, 10, 1, 2130706433, 'Menu', 126, '操作url：/winshop/index.php?s=/Admin/Menu/add.html', 1, 1396141726),
(21, 10, 1, 2130706433, 'Menu', 127, '操作url：/winshop/index.php?s=/Admin/Menu/add.html', 1, 1396141828),
(22, 10, 1, 2130706433, 'Menu', 128, '操作url：/winshop/index.php?s=/Admin/Menu/add.html', 1, 1396141868),
(23, 10, 1, 2130706433, 'Menu', 126, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1396143532),
(24, 10, 1, 2130706433, 'Menu', 127, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1396143542),
(25, 10, 1, 2130706433, 'Menu', 128, '操作url：/winshop/index.php?s=/Admin/Menu/edit.html', 1, 1396143552),
...
CREATE TABLE IF NOT EXISTS `winshop_addons` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
--
-- 表的结构 `winshop_attachment`
--

CREATE TABLE IF NOT EXISTS `winshop_attachment` (
...
--
-- 表的结构 `winshop_attribute`
--

CREATE TABLE IF NOT EXISTS `winshop_attribute` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `winshop_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
...
--
-- 表的结构 `winshop_auth_extend`
--

CREATE TABLE IF NOT EXISTS `winshop_auth_extend` (
...
--
-- 转存表中的数据 `winshop_auth_extend`
--

INSERT INTO `winshop_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
(1, 1, 1),
(1, 1, 2),
(1, 2, 1),
(1, 2, 2),
...
--
-- 表的结构 `winshop_auth_group`
--

CREATE TABLE IF NOT EXISTS `winshop_auth_group` (
...
--
-- 表的结构 `winshop_auth_group_access`
--

CREATE TABLE IF NOT EXISTS `winshop_auth_group_access` (
...
--
-- 表的结构 `winshop_auth_rule`
--

CREATE TABLE IF NOT EXISTS `winshop_auth_rule` (
...
--
-- 转存表中的数据 `winshop_auth_rule`
--

INSERT INTO `winshop_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`) VALUES
...
(217, 'admin', 1, 'Admin/Index/index', '基本信息', 1, ''),
(218, 'admin', 1, 'Admin/Item/index', '商品列表', 1, ''),
(219, 'admin', 1, 'Admin/Item/draftbox', '草稿箱', 1, ''),
(220, 'admin', 1, 'Admin/Item/recyle', '回收站', 1, ''),
(221, 'admin', 1, 'Admin/Index/cleancache', '缓存清理', 1, ''),
(222, 'admin', 2, 'Admin/Item/index', '商品', 1, ''),
(223, 'admin', 1, 'Admin/Index/adminlog', '管理日志', 1, '');

-- --------------------------------------------------------

--
-- 表的结构 `winshop_category`
--

CREATE TABLE IF NOT EXISTS `winshop_category` (
...
--
-- 表的结构 `winshop_channel`
--

CREATE TABLE IF NOT EXISTS `winshop_channel` (
...
--
-- 转存表中的数据 `winshop_channel`
--

INSERT INTO `winshop_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`) VALUES
...
CREATE TABLE IF NOT EXISTS `winshop_config` (
...
--
-- 转存表中的数据 `winshop_config`
--

INSERT INTO `winshop_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
...
--
-- 表的结构 `winshop_document`
--

CREATE TABLE IF NOT EXISTS `winshop_document` (
...
--
-- 表的结构 `winshop_document_article`
--

CREATE TABLE IF NOT EXISTS `winshop_document_article` (
...
--
-- 转存表中的数据 `winshop_document_article`
--
...
--
-- 表的结构 `winshop_document_download`
--

CREATE TABLE IF NOT EXISTS `winshop_document_download` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
CREATE TABLE IF NOT EXISTS `winshop_file` (
...
CREATE TABLE IF NOT EXISTS `winshop_hooks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
--
-- 转存表中的数据 `winshop_hooks`
--

INSERT INTO `winshop_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`) VALUES
...
CREATE TABLE IF NOT EXISTS `winshop_member` (
...
CREATE TABLE IF NOT EXISTS `winshop_menu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '文档ID',
...
(122, '缓存清理', 1, 1, 'Index/cleancache', 0, '清空系统缓存', '常用管理', 0),
(123, '管理日志', 1, 2, 'Index/adminlog', 0, '', '常用管理', 0),
(124, '基本信息', 1, 0, 'Index/index', 0, '', '常用管理', 0),
(125, '商品', 0, 1, 'Item/index', 0, '', '', 0),
(126, '商品列表', 125, 0, 'Item/index', 0, '', '商品管理', 0),
(127, '草稿箱', 125, 0, 'Item/draftbox', 0, '', '商品管理', 0),
(128, '回收站', 125, 0, 'Item/recyle', 0, '', '商品管理', 0),
(129, '新增', 126, 0, 'Item/add', 0, '', '', 0),
(130, '上架', 126, 0, 'Item/sale', 0, '', '', 0),
(131, '编辑', 126, 0, 'Item/edit\r', 0, '', '', 0),
(132, '删除', 126, 0, 'Item/del', 0, '', '', 0);
...
CREATE TABLE IF NOT EXISTS `winshop_model` (
...
--
-- 表的结构 `winshop_picture`
--

CREATE TABLE IF NOT EXISTS `winshop_picture` (
...
--
-- 表的结构 `winshop_ucenter_admin`
--

CREATE TABLE IF NOT EXISTS `winshop_ucenter_admin` (
...
--
-- 表的结构 `winshop_ucenter_app`
--

CREATE TABLE IF NOT EXISTS `winshop_ucenter_app` (
...
--
-- 表的结构 `winshop_ucenter_member`
--

CREATE TABLE IF NOT EXISTS `winshop_ucenter_member` (
...
--
-- 转存表中的数据 `winshop_ucenter_member`
--
...
--
-- 表的结构 `winshop_ucenter_setting`
--

CREATE TABLE IF NOT EXISTS `winshop_ucenter_setting` (
...
CREATE TABLE IF NOT EXISTS `winshop_url` (
...
--
-- 表的结构 `winshop_userdata`
--

CREATE TABLE IF NOT EXISTS `winshop_userdata` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
