...
--
-- 表的结构 `winshop_account_log`
--

CREATE TABLE IF NOT EXISTS `winshop_account_log` (
...
--
-- 表的结构 `winshop_address`
--

CREATE TABLE IF NOT EXISTS `winshop_address` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL COMMENT '用户ID',
...
INSERT INTO `winshop_admin` (`id`, `admin_name`, `password`, `role_id`, `create_time`, `email`, `last_ip`, `last_time`, `is_del`) VALUES
(1, 'admin', '7fef6171469e80d32c0559f88b377245', 0, '2014-02-10 09:32:00', NULL, '127.0.0.1', '2014-02-10 16:32:22', 0);

-- --------------------------------------------------------

--
-- 表的结构 `winshop_admin_role`
--

CREATE TABLE IF NOT EXISTS `winshop_admin_role` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_ad_manage`
--

CREATE TABLE IF NOT EXISTS `winshop_ad_manage` (
...
--
-- 转存表中的数据 `winshop_ad_manage`
--

INSERT INTO `winshop_ad_manage` (`id`, `name`, `type`, `position_id`, `link`, `order`, `width`, `height`, `start_time`, `end_time`, `content`, `description`) VALUES
...
(22, '文章公告内容页左侧', 1, 10, 'http://www.jooyea.cn', 99, 0, 0, '2011-05-02', '2015-12-10', 'upload/2011/06/07/20110607105620728.png', '1'),
(24, '首页中部通栏广告', 1, 6, 'http://www.google.com', 99, 0, 0, '2011-05-03', '2015-06-11', 'upload/2011/06/07/20110607105547573.png', '首页中部通栏广告');

-- --------------------------------------------------------

--
-- 表的结构 `winshop_ad_position`
--

CREATE TABLE IF NOT EXISTS `winshop_ad_position` (
...
--
-- 转存表中的数据 `winshop_ad_position`
--

INSERT INTO `winshop_ad_position` (`id`, `name`, `width`, `height`, `type`, `fashion`, `status`, `ad_nums`) VALUES
...
--
-- 表的结构 `winshop_announcement`
--

CREATE TABLE IF NOT EXISTS `winshop_announcement` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `winshop_areas` (
  ...
  PRIMARY KEY (`area_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='地区信息' AUTO_INCREMENT=659005 ;

--
-- 转存表中的数据 `winshop_areas`
--

INSERT INTO `winshop_areas` (`area_id`, `parent_id`, `area_name`, `sort`) VALUES
(110000, 0, '北京市', 99),
(120000, 0, '天津市', 99),
(130000, 0, '河北省', 99),
(140000, 0, '山西省', 99),
...
--
-- 表的结构 `winshop_article`
--

CREATE TABLE IF NOT EXISTS `winshop_article` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_article_category`
--

CREATE TABLE IF NOT EXISTS `winshop_article_category` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `winshop_brand` (
...
--
-- 表的结构 `winshop_brand_category`
--

CREATE TABLE IF NOT EXISTS `winshop_brand_category` (
...
--
-- 表的结构 `winshop_category_extend`
--

CREATE TABLE IF NOT EXISTS `winshop_category_extend` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='商品扩展分类表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `winshop_collection_doc`
--

CREATE TABLE IF NOT EXISTS `winshop_collection_doc` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_commend_goods`
--

CREATE TABLE IF NOT EXISTS `winshop_commend_goods` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `commend_id` int(11) unsigned NOT NULL COMMENT '推荐类型ID 1:最新商品 2:特价商品 3:热卖排行 4:推荐商品',
  `goods_id` int(11) unsigned NOT NULL COMMENT '商品ID',
  PRIMARY KEY (`id`),
  KEY `goods_id` (`goods_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='推荐类商品' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `winshop_comment`
--

CREATE TABLE IF NOT EXISTS `winshop_comment` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) unsigned NOT NULL COMMENT '商品ID',
...
--
-- 表的结构 `winshop_delivery`
--

CREATE TABLE IF NOT EXISTS `winshop_delivery` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='配送方式表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `winshop_delivery`
--

INSERT INTO `winshop_delivery` (`id`, `name`, `description`, `area_groupid`, `firstprice`, `secondprice`, `type`, `first_weight`, `second_weight`, `first_price`, `second_price`, `status`, `sort`, `is_save_price`, `save_rate`, `low_price`, `price_type`, `open_default`, `is_delete`, `freight_id`) VALUES
(1, '快递', '直接由第三方物流公司配送', 'N;', 'N;', 'N;', 0, 1000, 1000, 20.00, 20.00, 1, 0, 0, 0.00, 0.00, 0, 0, 0, 1);

-- --------------------------------------------------------

--
-- 表的结构 `winshop_delivery_doc`
--

CREATE TABLE IF NOT EXISTS `winshop_delivery_doc` (
...
--
-- 表的结构 `winshop_delivery_goods`
--

CREATE TABLE IF NOT EXISTS `winshop_delivery_goods` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_discussion`
--

CREATE TABLE IF NOT EXISTS `winshop_discussion` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) unsigned NOT NULL COMMENT '商品ID',
  `user_id` int(11) unsigned NOT NULL COMMENT '用户ID',
...
--
-- 表的结构 `winshop_email_registry`
--

CREATE TABLE IF NOT EXISTS `winshop_email_registry` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_expresswaybill`
--

CREATE TABLE IF NOT EXISTS `winshop_expresswaybill` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `winshop_expresswaybill`
--

INSERT INTO `winshop_expresswaybill` (`id`, `name`, `config`, `background`, `width`, `height`, `is_close`) VALUES
...
--
-- 表的结构 `winshop_favorite`
--

CREATE TABLE IF NOT EXISTS `winshop_favorite` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL COMMENT '用户ID',
...
--
-- 表的结构 `winshop_find_password`
--

CREATE TABLE IF NOT EXISTS `winshop_find_password` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL COMMENT '用户ID',
...
--
-- 表的结构 `winshop_freight_company`
--

CREATE TABLE IF NOT EXISTS `winshop_freight_company` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `winshop_freight_company`
--

INSERT INTO `winshop_freight_company` (`id`, `freight_type`, `freight_name`, `url`, `sort`, `is_del`) VALUES
...
CREATE TABLE IF NOT EXISTS `winshop_goods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品信息表' AUTO_INCREMENT=18 ;

--
-- 转存表中的数据 `winshop_goods`
--

INSERT INTO `winshop_goods` (`id`, `name`, `goods_no`, `model_id`, `sell_price`, `market_price`, `cost_price`, `up_time`, `down_time`, `create_time`, `store_nums`, `img`, `is_del`, `content`, `keywords`, `description`, `search_words`, `weight`, `point`, `unit`, `brand_id`, `visit`, `favorite`, `sort`, `spec_array`, `exp`, `comments`, `sale`, `grade`) VALUES
(1, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(2, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(3, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(4, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(5, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(6, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(7, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(8, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(9, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(10, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(11, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(12, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(13, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(14, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(15, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(16, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0),
(17, 'ThinkPHP', '1000', 0, 122.20, 525.00, NULL, NULL, NULL, '0000-00-00 00:00:00', 0, NULL, 0, NULL, NULL, NULL, NULL, 0.00, 0, NULL, NULL, 0, 0, 99, NULL, 0, 0, 0, 0);

-- --------------------------------------------------------

--
-- 表的结构 `winshop_goods_attribute`
--

CREATE TABLE IF NOT EXISTS `winshop_goods_attribute` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) unsigned NOT NULL COMMENT '商品ID',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='属性值表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `winshop_goods_car`
--

CREATE TABLE IF NOT EXISTS `winshop_goods_car` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL COMMENT '用户ID',
...
--
-- 表的结构 `winshop_goods_photo`
--

CREATE TABLE IF NOT EXISTS `winshop_goods_photo` (
...
--
-- 表的结构 `winshop_goods_photo_relation`
--

CREATE TABLE IF NOT EXISTS `winshop_goods_photo_relation` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) unsigned NOT NULL COMMENT '商品ID',
  `photo_id` char(32) NOT NULL DEFAULT '' COMMENT '图片ID,图片的md5值',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='相册商品关系表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `winshop_group_price`
--

CREATE TABLE IF NOT EXISTS `winshop_group_price` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='记录某件商品对于某组会员的价格关系表，优先权大于组设定的折扣率。' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `winshop_guide` (
...
CREATE TABLE IF NOT EXISTS `winshop_help` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `winshop_help`
--

INSERT INTO `winshop_help` (`id`, `cat_id`, `sort`, `name`, `content`, `dateline`) VALUES
...
--
-- 表的结构 `winshop_help_category`
--

CREATE TABLE IF NOT EXISTS `winshop_help_category` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `winshop_help_category`
--

INSERT INTO `winshop_help_category` (`id`, `name`, `sort`, `position_left`, `position_foot`) VALUES
(4, '支付帮助', 2, 0, 1),
(3, '购物指南', 1, 0, 1),
(5, '售后服务', 4, 1, 1),
(6, '配送帮助', 3, 0, 1),
...
--
-- 表的结构 `winshop_keyword`
--

CREATE TABLE IF NOT EXISTS `winshop_keyword` (
...
--
-- 表的结构 `winshop_log_error`
--

CREATE TABLE IF NOT EXISTS `winshop_log_error` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_log_operation`
--

CREATE TABLE IF NOT EXISTS `winshop_log_operation` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_log_sql`
--

CREATE TABLE IF NOT EXISTS `winshop_log_sql` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_merch_ship_info`
--

CREATE TABLE IF NOT EXISTS `winshop_merch_ship_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_message`
--

CREATE TABLE IF NOT EXISTS `winshop_message` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_msg_template`
--

CREATE TABLE IF NOT EXISTS `winshop_msg_template` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `winshop_msg_template`
--

INSERT INTO `winshop_msg_template` (`id`, `name`, `title`, `content`, `variable`) VALUES
...
--
-- 表的结构 `winshop_notify_registry`
--

CREATE TABLE IF NOT EXISTS `winshop_notify_registry` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) unsigned NOT NULL COMMENT '商品ID',
  `user_id` int(11) unsigned NOT NULL COMMENT '用户ID',
...
CREATE TABLE IF NOT EXISTS `winshop_oauth` (
...
--
-- 转存表中的数据 `winshop_oauth`
--

INSERT INTO `winshop_oauth` (`id`, `name`, `config`, `file`, `description`, `is_close`, `logo`) VALUES
...
--
-- 表的结构 `winshop_oauth_user`
--

CREATE TABLE IF NOT EXISTS `winshop_oauth_user` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_online_recharge`
--

CREATE TABLE IF NOT EXISTS `winshop_online_recharge` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL COMMENT '用户id',
...
CREATE TABLE IF NOT EXISTS `winshop_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_order_goods`
--

CREATE TABLE IF NOT EXISTS `winshop_order_goods` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` int(11) unsigned NOT NULL COMMENT '订单ID',
  `goods_id` int(11) unsigned DEFAULT NULL COMMENT '商品ID',
...
--
-- 表的结构 `winshop_order_log`
--

CREATE TABLE IF NOT EXISTS `winshop_order_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_order_prop_relation`
--

CREATE TABLE IF NOT EXISTS `winshop_order_prop_relation` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_payment`
--

CREATE TABLE IF NOT EXISTS `winshop_payment` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='支付方式表' AUTO_INCREMENT=10 ;

--
-- 转存表中的数据 `winshop_payment`
--

INSERT INTO `winshop_payment` (`id`, `name`, `type`, `class_name`, `description`, `logo`, `status`, `order`, `note`, `poundage`, `poundage_type`, `partner_id`, `partner_key`) VALUES
...
--
-- 表的结构 `winshop_point_log`
--

CREATE TABLE IF NOT EXISTS `winshop_point_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL COMMENT '用户id',
...
--
-- 表的结构 `winshop_products`
--

CREATE TABLE IF NOT EXISTS `winshop_products` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `weight` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT '重量',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='货品表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `winshop_promotion`
--

CREATE TABLE IF NOT EXISTS `winshop_promotion` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `winshop_prop` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_quick_naviga`
--

CREATE TABLE IF NOT EXISTS `winshop_quick_naviga` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `admin_id` int(11) unsigned NOT NULL COMMENT '管理员id',
...
CREATE TABLE IF NOT EXISTS `winshop_refer` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_refundment_doc`
--

CREATE TABLE IF NOT EXISTS `winshop_refundment_doc` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_regiment`
--

CREATE TABLE IF NOT EXISTS `winshop_regiment` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_regiment_user_relation`
--

CREATE TABLE IF NOT EXISTS `winshop_regiment_user_relation` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL COMMENT '用户id',
...
--
-- 表的结构 `winshop_relation`
--

CREATE TABLE IF NOT EXISTS `winshop_relation` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) unsigned NOT NULL COMMENT '商品ID',
...
CREATE TABLE IF NOT EXISTS `winshop_right` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) NOT NULL COMMENT '权限名字',
  `right` text COMMENT '权限码(控制器+动作)',
  `is_del` tinyint(1) NOT NULL DEFAULT '0' COMMENT '删除状态 1删除,0正常',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='权限资源码' AUTO_INCREMENT=125 ;

--
-- 转存表中的数据 `winshop_right`
--

INSERT INTO `winshop_right` (`id`, `name`, `right`, `is_del`) VALUES
(1, '[商品]商品列表', 'goods@goods_list,goods@goods_stats', 0),
(2, '[商品]商品添加修改', 'goods@goods_img_upload,goods@goods_edit,goods@goods_update,goods@member_price,goods@model_init,goods@attribute_init,goods@search_spec,goods@select_spec', 0),
(3, '[商品]商品CSV导入', 'goods@csvImport,goods@importCsvFile', 0),
(4, '[商品]商品删除', 'goods@goods_del', 0),
(5, '[商品]商品回收站', 'goods@goods_recycle_del,goods@goods_recycle_restore,goods@goods_recycle_list', 0),
(6, '[商品]商品分类列表', 'goods@category_list,goods@category_sort', 0),
(7, '[商品]商品分类添加修改', 'goods@category_edit,goods@category_save', 0),
(8, '[商品]商品分类删除', 'goods@category_del', 0),
(9, '[商品]品牌列表', 'brand@brand_list,goods@brand_sort', 0),
(10, '[商品]品牌添加修改', 'brand@brand_save,brand@brand_edit', 0),
(11, '[商品]品牌删除', 'brand@brand_del', 0),
(12, '[商品]品牌分类列表', 'brand@category_list', 0),
(13, '[商品]品牌分类添加修改', 'brand@category_save,brand@category_edit', 0),
(14, '[商品]品牌分类删除', 'brand@category_del', 0),
(15, '[商品]模型列表', 'goods@model_list', 0),
(16, '[商品]模型添加修改', 'goods@search_spec,goods@model_update,goods@model_edit', 0),
(17, '[商品]模型删除', 'goods@model_del', 0),
(18, '[商品]规格列表', 'goods@spec_list', 0),
(19, '[商品]规格添加修改', 'goods@spec_edit,goods@spec_update', 0),
(20, '[商品]规格删除', 'goods@spec_del', 0),
(21, '[商品]规格图库', 'goods@spec_photo,goods@spec_photo_del', 0),
(22, '[商品]规格回收站', 'goods@spec_recycle_list,goods@spec_recycle_restore,goods@spec_recycle_del,goods@spec_del', 0),
(23, '[会员]会员列表', 'member@member_list', 0),
(24, '[会员]会员添加修改', 'member@member_edit,member@member_save', 0),
(25, '[会员]会员删除', 'member@member_reclaim', 0),
(26, '[会员]会员回收站', 'member@member_del,member@member_restore,member@recycling', 0),
(27, '[会员]会员预付款操作', 'member@member_recharge', 0),
(28, '[会员]会员组列表', 'member@group_list', 0),
(29, '[会员]会员组添加修改', 'member@group_edit,member@group_save', 0),
(30, '[会员]会员组删除', 'member@group_del', 0),
(31, '[会员]会员提现列表', 'member@withdraw_list', 0),
(32, '[会员]会员提现删除', 'member@withdraw_del', 0),
(33, '[会员]会员提现回收站', 'member@withdraw_update,member@withdraw_recycle', 0),
(34, '[会员]会员提现状态修改', 'member@withdraw_status', 0),
(35, '[会员]会员提现详情', 'member@withdraw_detail', 0),
(36, '[会员]建议列表', 'comment@suggestion_list', 0),
(37, '[会员]建议详情', 'comment@suggestion_edit', 0),
(38, '[会员]建议回复', 'comment@suggestion_edit_act', 0),
(39, '[会员]建议删除', 'comment@suggestion_del', 0),
(40, '[会员]咨询列表', 'comment@refer_list', 0),
(41, '[会员]咨询详情', 'comment@refer_edit', 0),
(42, '[会员]咨询回复', 'comment@refer_reply', 0),
(43, '[会员]咨询删除', 'comment@refer_del', 0),
(44, '[会员]讨论列表', 'comment@discussion_list', 0),
(45, '[会员]讨论详情', 'comment@discussion_edit', 0),
(46, '[会员]讨论删除', 'comment@discussion_del', 0),
(47, '[会员]评价列表', 'comment@comment_list', 0),
(48, '[会员]评价详情', 'comment@comment_edit', 0),
(49, '[会员]评价删除', 'comment@comment_del', 0),
(50, '[会员]站内消息列表', 'comment@message_list', 0),
(51, '[会员]站内消息发送', 'comment@message_send', 0),
(52, '[会员]站内消息删除', 'comment@message_del', 0),
(53, '[会员]到货通知列表', 'message@notify_list,message@notify_filter', 0),
(54, '[会员]到货通知删除', 'message@notify_del', 0),
(55, '[会员]到货通知发送Email', 'message@notify_send', 0),
(56, '[会员]到货通知导出CSV', 'message@notify_export', 0),
(57, '[会员]消息模板展示', 'message@tpl_list', 0),
(58, '[会员]邮件订阅列表', 'message@registry_list', 0),
(59, '[会员]邮件订阅发送', 'message@registry_message_send', 0),
(60, '[会员]邮件订阅删除', 'message@registry_del', 0),
(61, '[会员]邮件订阅导出CSV', 'message@registry_export', 0),
(62, '[会员]消息模板修改', 'message@tpl_edit,message@tpl_save', 0),
(63, '[订单]订单列表', 'order@order_list', 0),
(64, '[订单]订单添加', 'order@order_note,order@order_update,order@order_edit', 0),
(65, '[订单]订单修改', 'order@gePay_fee,order@order_pri_num,order@order_pri_num_del,order@order_note,order@order_update,order@order_edit,order@order_message', 0),
(66, '[订单]订单详情', 'order@order_show', 0),
(67, '[订单]订单回收站', 'order@order_recycle_restore,order@order_recycle_del,order@order_recycle_list', 0),
(68, '[订单]订单打印', 'order@merge_template,order@pick_template,order@shop_template,order@template,order@print_template_update,order@print_template', 0),
(69, '[订单]订单删除', 'order@order_del', 0),
(70, '[订单]订单状态修改', 'order@order_delivery_doc,order@order_collection_doc,order@order_complete,order@order_refundment,order@order_collection,order@order_deliver', 0),
(71, '[订单]收款单列表', 'order@order_collection_list', 0),
(72, '[订单]收款单详情', 'order@order_collection,order@collection_show', 0),
(73, '[订单]收款单删除', 'order@collection_del', 0),
(74, '[订单]收款单回收站', 'order@collection_recycle_restore,order@collection_recycle_del,order@collection_recycle_list', 0),
(75, '[订单]退款单列表', 'order@order_refundment_list', 0),
(76, '[订单]退款单删除', 'order@order_refundment_del', 0),
(77, '[订单]退款单回收站', 'order@refundment_recycle_list,order@refundment_recycle_restore,order@refundment_recycle_del', 0),
(78, '[订单]退款单详情', 'order@refundment_show,order@order_refundment', 0),
(79, '[订单]配货单列表', 'order@order_delivery_list', 0),
(80, '[订单]配货单删除', 'order@delivery_del', 0),
(81, '[订单]配货单回收站', 'order@delivery_recycle_list,order@delivery_recycle_restore,order@delivery_recycle_del', 0),
(82, '[订单]退款申请单列表', 'order@refundment_list', 0),
(83, '[订单]退款申请单详情', 'order@refundment_doc_show', 0),
(84, '[订单]退款申请单删除', 'order@refundment_doc_del', 0),
(85, '[订单]退款申请单修改', 'order@refundment_doc_show_save', 0),
(86, '[订单]快递单添加修改', 'order@expresswaybill_edit,order@expresswaybill_edit_act,order@expresswaybill_upload,order@expresswaybill_template', 0),
(87, '[订单]快递单删除', 'order@expresswaybill_del', 0),
(88, '[订单]订单退款操作', 'order@order_refundment_doc', 0),
(89, '[订单]配货单详情', 'order@delivery_show', 0),
(90, '[营销]促销规则列表', 'market@pro_rule_list', 0),
(91, '[营销]促销规则添加修改', 'market@pro_rule_edit_act,market@pro_rule_edit,market@getTicketList', 0),
(92, '[营销]促销规则删除', 'market@pro_rule_del', 0),
(93, '[营销]限时抢购列表', 'market@pro_speed_list', 0),
(94, '[营销]限时抢购删除', 'market@pro_speed_del', 0),
(95, '[营销]限时抢购添加修改', 'market@pro_speed_edit,market@pro_speed_edit_act', 0),
(96, '[营销]团购列表', 'market@regiment_list', 0),
(97, '[营销]团购添加修改', 'market@regiment_edit_act,market@regiment_edit', 0),
(98, '[营销]团购删除', 'market@regiment_del', 0),
(99, '[营销]代金券列表', 'market@ticket_list', 0),
(100, '[营销]代金券文件列表', 'market@ticket_excel_list', 0),
(101, '[营销]代金券添加修改', 'market@ticket_edit_act,market@ticket_edit', 0),
(102, '[营销]代金券文件详情', 'market@ticket_more_list', 0),
(103, '[营销]代金券删除', 'market@ticket_more_del,market@ticket_del', 0),
(104, '[营销]代金券文件删除', 'market@ticket_excel_del', 0),
(105, '[营销]代金券批量生成', 'market@ticket_create', 0),
(106, '[营销]代金券EXCEL导出', 'market@ticket_excel_pack,market@ticket_excel', 0),
(107, '[营销]代金券文件打包下载', 'market@ticket_excel_pack', 0),
(108, '[营销]代金券文件下载', 'market@ticket_excel_download', 0),
(109, '[营销]代金券状态修改', 'market@ticket_status', 0),
(110, '[统计]基础数据统计', 'market@init_count,market@spanding_avg,market@amount,market@user_reg', 0),
(111, '[统计]资金操作记录', 'market@operation_list', 0),
(112, '[统计]后台操作记录', 'market@account_list', 0),
(113, '[统计]资金和后台操作记录删除', 'market@clear_log', 0),
(114, '[系统]网站设置', 'system@test_sendmail,system@clearCache,system@conf_skin,system@save_conf,system@conf_base', 0),
(115, '[系统]主题设置', 'system@applySkin,system@applyTheme,system@conf_skin', 0),
(116, '[系统]支付管理', 'system@payment_update,system@payment_edit,system@payment_list', 0),
(117, '[系统]配送管理', 'system@freight_recycle_del,system@freight_recycle_restore,system@freight_recycle,system@freight_del,system@freight_update,system@delivery_update,system@delivery_operate,system@delivery_edit,system@freight_edit,system@freight_list,system@delivery,system@delivery_recycle', 0),
(118, '[系统]地域管理', 'system@area_list,system@area_update,system@area_del', 0),
(119, '[工具]数据库备份', 'tools@db_act_bak,tools@db_bak,tools@upload_sql', 0),
...
CREATE TABLE IF NOT EXISTS `winshop_search` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `winshop_spec` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='规格表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `winshop_spec_photo`
--

CREATE TABLE IF NOT EXISTS `winshop_spec_photo` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `address` varchar(255) DEFAULT NULL COMMENT '图片地址',
  `name` varchar(100) DEFAULT NULL COMMENT '图片名称',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='规格图片表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `winshop_suggestion`
--

CREATE TABLE IF NOT EXISTS `winshop_suggestion` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL COMMENT '用户ID',
  `title` varchar(255) NOT NULL COMMENT '标题',
  `content` text NOT NULL COMMENT '内容',
...
CREATE TABLE IF NOT EXISTS `winshop_ticket` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `winshop_user` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `winshop_user_group`
--

CREATE TABLE IF NOT EXISTS `winshop_user_group` (
...
--
-- 表的结构 `winshop_withdraw`
--

CREATE TABLE IF NOT EXISTS `winshop_withdraw` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL COMMENT '用户ID',
  `time` datetime NOT NULL COMMENT '时间',
  `amount` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT '金额',
