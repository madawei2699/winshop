...
<head>
	<meta charset="UTF-8">
	<title><?php echo ($meta_title); ?>|WinShop管理平台</title>
	<link href="/winshop/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
	<link rel="stylesheet" type="text/css" href="/winshop/Public/Admin/css/base.css" media="all">
	<link rel="stylesheet" type="text/css" href="/winshop/Public/Admin/css/common.css" media="all">
	<link rel="stylesheet" type="text/css" href="/winshop/Public/Admin/css/module.css">
	<link rel="stylesheet" type="text/css" href="/winshop/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/winshop/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
	 <!--[if lt IE 9]>
	<script type="text/javascript" src="/winshop/Public/static/js/jquery-1.10.2.min.js"></script>
	<![endif]--><!--[if gte IE 9]><!-->
	<script type="text/javascript" src="/winshop/Public/static/js/jquery-2.0.3.min.js"></script>
	<script type="text/javascript" src="/winshop/Public/Admin/js/jquery.mousewheel.js"></script>
	<!--<![endif]-->
...
<script>
	...
	<script type="text/javascript" src="/winshop/Public/static/js/think.js"></script>
	<script type="text/javascript" src="/winshop/Public/Admin/js/common.js"></script>
	<script type="text/javascript">
		+function(){
...
<link href="/winshop/Public/static/js/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/winshop/Public/static/js/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/winshop/Public/static/js/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/winshop/Public/static/js/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/winshop/Public/static/js/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
$(function(){
	//搜索功能
